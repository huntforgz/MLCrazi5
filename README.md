...
For FeatureCompute.py, if you want to test it on you own server, be sure that your test environment has already been install Python3, opencv and relative package.
